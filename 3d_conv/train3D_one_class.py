"""Script for training Inception-v1 Inflated 3D ConvNet with the NCAA Dataset"""
import sys
sys.path.insert(0,'/home/ubuntu/soccer_videos/')
...
from conv_3D.aux_functions.soccer_functions import load_metrics
from conv_3D.aux_functions.soccer_functions import metric_generator
from conv_3D.aux_functions.soccer_functions import filter_clips
from conv_3D.aux_functions.soccer_functions import transform_data
from conv_3D.models.conv_3D_softmax import import_model
...
class DataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, dataframe, folder, batch_size, train_class=False, start_idx = 0, end_idx = 24, norm = 'div', file_prefix = '', load_before=False, aug=False, dim=(24, 224, 224, 3), n_classes=11, shuffle=False):
        ...
        if self.train_class != False:
            ...
            self.labels = pd.get_dummies(dataframe['type'])
...
#    parallel_model = multi_gpu_model(model, gpus=2)
    ...
    X_train = pd.read_pickle('/home/ubuntu/soccer_videos/data/comprehensive_soccer_dataset/X_train_full_no_replay.pkl')
    X_val = pd.read_pickle('/home/ubuntu/soccer_videos/data/comprehensive_soccer_dataset/X_val_full_no_replay.pkl')
    X_test = pd.read_pickle('/home/ubuntu/soccer_videos/data/comprehensive_soccer_dataset/X_test_full_no_replay.pkl')
    ...
    if type(eval_class) == list:
        ...
        train_rows = train_df['type'] == eval_class

#     Generators
    validation_generator = DataGenerator(val_df, '/home/ubuntu/soccer_videos/data/comprehensive_soccer_dataset/', train_class=eval_class, batch_size=batch_size, n_classes=classes)
    training_generator = DataGenerator(train_df, '/home/ubuntu/soccer_videos/data/comprehensive_soccer_dataset/', train_class=eval_class, aug=True, batch_size=batch_size, n_classes=classes)
